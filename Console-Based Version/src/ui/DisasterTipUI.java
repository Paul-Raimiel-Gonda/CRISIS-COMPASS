...
public class DisasterTipUI {
    ...
    public void displayDisasterTipMenu() {
        ...
        while (true) {
            System.out.println("\n--- Disaster Tips Menu ---");
            System.out.println("1. Choose Disaster Type");
            ...
            switch (choice) {
                ...
                case 2 -> {
                    ...
                    return; // Return to Main Menu without invoking UserUI
                }
    ...
    private void selectDisasterType() {
        ...
        while (disaster == null) {
            System.out.print("\nEnter disaster type (Drought, Earthquake, Flood, Typhoon, VolcanicEruption) or 'back' to return: ");
